...
public class ListCompare {
    public static void main(String[] args) throws ParseException {
        List<CompareUser> users = new ArrayList<>();
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");

        boolean b = users.addAll(Arrays.asList(
                new CompareUser("5", "张三", simpleDateFormat.parse("2025-12-12 00:00:00")),
                new CompareUser("1", "李四", simpleDateFormat.parse("2025-01-12 00:00:00")),
                new CompareUser("4", "王二", simpleDateFormat.parse("2025-07-12 00:00:00")),
                new CompareUser("2", "赵钱", simpleDateFormat.parse("2025-05-12 00:00:00")),
                new CompareUser("3", "前六", null)
        ));
        Date now = new Date();
...
//        );
        ...
        // 完全展开的比较器定义
        Comparator<CompareUser> birthdayComparator = new Comparator<CompareUser>() {
            @Override
            public int compare(CompareUser user1, CompareUser user2) {
